const level1_spell_list = {
    ...
    'Fireball' : new Spell('Fireball', 
        ...
        new SpellPattern(patterns.CIRCULAR, 400, 100, 1, castType.ON_LOCATION),
        '2d6'),
    'Ice Cone' : new Spell('Ice Cone', 
        ...
        new SpellPattern(patterns.CONE_UPWARD, 400, 100, 1, castType.FROM_CASTER),
        '1d6'),
    'Fire Hands' : new Spell('Fire Hands', 
        ...
        'Burn them all !!!!.', 
        {'1': new AdditionalEffect(characterActions.CASTING, additionalEffects.ATTACK_BONUS, 2, 'Increase Attack Damage')}, 
        new SpellPattern(patterns.CONE_DOWNWARD, 400, 100, 1, castType.FROM_CASTER),
        '1d6'),
    'Lightning Ray' : new Spell('Lightning Ray', 
        ...
        new SpellPattern(patterns.BOX, 400, 100, 1, castType.FROM_CASTER),
        '3d8'),
    };