...
from program.ui.Ui_page_add_background import Ui_PageAddBackground
...
class PageAddChar(QWidget):
    ...
    def save(self):
        char_name = self.ui.lineEdit_sceneName.text().strip()  # Get character name
